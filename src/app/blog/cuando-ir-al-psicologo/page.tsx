...
export const metadata: Metadata = {
    title: "¿Cuándo ir al psicólogo? Rompiendo mitos | Bienestar Emocional",
...
const jsonLd = {
    ...
    description: "Artículo sobre la importancia del apoyo emocional y cómo identificar cuándo pedir ayuda.",
        ...
        <div className="min-h-screen pt-20 pb-16 px-4">
            ...
            <article className="max-w-4xl mx-auto">
                ...
                <div className="prose prose-lg max-w-none text-justify">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-8">
                        Quiero recalcar que buscar apoyo emocional no siempre ocurre en medio de una crisis; a veces surge como un acto de cuidado, escucha y respeto hacia lo que sientes.
                    </p>

                    <p className="text-gray-700 leading-relaxed mb-8">
                        Es importante aclarar que los espacios de orientación emocional pueden ayudarte a transitar procesos difíciles, validar y cuidar tus emociones. Este tipo de orientación no reemplaza evaluación clínica, diagnóstico ni tratamiento médico.
                    </p>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-8">
                        Volviendo al punto, saber cuándo necesitamos apoyo tiene que ver con señales que suelen pasarse por alto. Por ejemplo, cuando te sientes cansada emocionalmente sin una razón clara; cuando todo te abruma más de lo normal; o cuando notas que reaccionas de maneras que antes no eran habituales en ti.
                    </p>
